...
packer.init {
    -- git = {
    -- default_url_format = 'https://hub.fastgit.org/%s' -- Lua format string used for "aaa/bbb" style plugins
    -- },
    display = {
        open_fn = function()
...
return packer.startup(function(use)
    ...
    use "ZSaberLv0/ZFVimJob"            --用于提升词库加载性能
    use "ZSaberLv0/ZFVimGitUtil"        --定期自动清理词库 push 历史
    use "ORC-Lee/ZFVimIM_pinyin_base"   --词库
    use "ZSaberLv0/ZFVimIM_openapi"     --百度云输入法
